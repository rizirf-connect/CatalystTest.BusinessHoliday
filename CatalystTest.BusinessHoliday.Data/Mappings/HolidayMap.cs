    ...
    public class HolidayMap : IEntityTypeConfiguration<Holiday>
    {
        public void Configure(EntityTypeBuilder<Holiday> builder)
        {
            ...
            builder.HasData(
                ...
                new Holiday(Guid.NewGuid(), "Eid", DateTime.Now.AddDays(5), DateTime.Now.AddDays(3), true),
                new Holiday(Guid.NewGuid(), "Moharram", DateTime.Now.AddDays(10), DateTime.Now.AddDays(2), true),
                new Holiday(Guid.NewGuid(), "Iqbal", DateTime.Now.AddDays(15), DateTime.Now.AddDays(1), true),
                new Holiday(Guid.NewGuid(), "Christmas", DateTime.Now.AddDays(20), DateTime.Now.AddDays(1), false)
                );
        }
    }
}
